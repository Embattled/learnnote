- [1. C++ 特性](#1-c-特性)
  - [值类别 Value Categories](#值类别-value-categories)
    - [lvalue 左值](#lvalue-左值)
    - [prvalue 纯右值](#prvalue-纯右值)
  - [1.1. 程序参数配置](#11-程序参数配置)
    - [1.1.1. C的输出与C++流的同步](#111-c的输出与c流的同步)
    - [1.1.2. cin 和 cout 的绑定](#112-cin-和-cout-的绑定)
- [1.2. 类](#12-类)
  - [1.2.1. 初始化列表](#121-初始化列表)
  - [1.2.2. 类和struct的区别 C++中增强的struct](#122-类和struct的区别-c中增强的struct)
  - [1.2.3. 构造函数 转换构造函数](#123-构造函数-转换构造函数)
  - [1.3. 函数对象](#13-函数对象)
    - [1.3.1. 使用定义](#131-使用定义)
  - [1.3.2. STL 函数对象模板类](#132-stl-函数对象模板类)
  - [1.4. Operator Overloading 运算符重载](#14-operator-overloading-运算符重载)
    - [1.4.1. 为什么要以全局函数重载运算符 加号 +](#141-为什么要以全局函数重载运算符-加号-)
  - [1.5. const](#15-const)
    - [1.5.1. C语言的常量](#151-c语言的常量)
    - [1.5.2. C++的 const](#152-c的-const)
    - [1.5.3. 类的 const 函数](#153-类的-const-函数)
    - [1.5.4. const 对象](#154-const-对象)
...
## 1.4. Operator Overloading 运算符重载
