...
* 低音 : 指的是最低的音
* 根音 : 指的是构成和弦的根音, 在原位和弦种是低音, 否则有可能不是

转位: 以和弦的 357音为低音的和弦, 叫做 `转位和弦`  
* 三和弦有三个音, 除去根音之外, 剩下两个音作为低音的情况, `三和弦有两个转位`
  * 第一转位, 又称 六和弦, 以三和弦的三音为低音的和弦, 此时根音向上进行转位, 三音作为低音到最高音的音程为六度, 因此叫做六和弦 写作$大三_6$
  * 第二转为, 又称 四六和弦, 以三和弦的五音为低音的和弦, 根音和三音向上转位, 作为低音的五音到根音为四度, 到最高音三音为六度, 叫做四六和弦, 写作 $大三_{\underset{4}{6}}$
...
调 : 由基本音级所构成的音高位置, 一个正规的调 基本音级之间的音程需要保持与C调一致 `1全2全3半4全5全6全7半1`  
* C 调 : 比较特殊, 又称 基本调, 由七个基本音级所构成的调, 它的调号标记是没有升降记号的, 也是反推其他调式的基础
* D 调 : 2 - 3 - 升4 - 5 - 6 - 7 - 升1 - 2
* E 调 : 降3 - 4 - 5 - 降6 - 降7 - 1 - 2 - 降3
* F 调 : 4 - 5 - 6 - 降7 - 1 - 2 - 3 - 4        F 调 只有一个 降号
* G 调 : 5 - 6 - 7 - 1 - 2 - 3 - 升4 - 5        G 调 之所以常用, 是因为 G 调只需要加一个 升号 
* A 调 : 6 - 7 - 升1 - 2 - 3 - 4 - 升5 - 6
* B 调 : 降7 - 1 - 2 - 降3 - 4 - 5 - 6 - 降7 
