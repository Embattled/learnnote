...
- [2. C 表达式](#2-c-表达式)
  ...
  - [2.2. 运算符](#22-运算符)
    - [iso646.h](#iso646h)
    - [2.2.1. 特殊运算符](#221-特殊运算符)
- [3. C 保留字](#3-c-保留字)
  - [3.1. const](#31-const)
  - [volatile](#volatile)
  - [存储级别 Storage-class 描述符](#存储级别-storage-class-描述符)
- [4. C语言指针](#4-c语言指针)
  - [4.1. 野指针](#41-野指针)
  - [4.2. 指针的定义](#42-指针的定义)
...
// 获取一个配置变量的 __detachstate 值, 执行成功返回0
int pthread_attr_getdetachstate(const pthread_attr_t * attr,int * detachstate);
// 设置一个配置变量的 __detachstate 值, 执行成功返回0
int pthread_attr_setdetachstate(pthread_attr_t *sttr, int detachstate);
// 直接将一个线程的 __detachstate 更改为 DETACHED
